...
function startServer(config) {
  const { apiKey, port, host, serverName, enableDocker, enableOpenClaw, enableAiUsage, openclawDataDir, openclawDockerContainer, ecdhPrivateKey, ecdhPublicKey } = config;
      ...
      try {
        ...
        if (enableOpenClaw) {
          stats.openclaw = await collectOpenClawStats({ 
            dataDir: openclawDataDir,
            dockerContainer: openclawDockerContainer,
          });
        }
